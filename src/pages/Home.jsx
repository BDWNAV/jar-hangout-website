    ...
    return (
      <div>
        ...
        <div className="content">
          ...
          <button className="discord-login"><a href="https://discord.com/api/oauth2/authorize?client_id=868462835313827890&redirect_uri=http%3A%2F%2F91.109.116.52%3A40%2Fapi%2Fauth%2Fdiscord%2Fredirect&response_type=code&scope=identify">Verify</a></button>
        </div>
      </div>
    );
  }
